...
PRIVATE void resurectPlayer(Player aPlayer, Uint32* resurectTimer, Uint32* immunityTimer, int** nrOffSoundEffects);
...
PUBLIC void handlePlayerPowers(Player aPlayer, Uint32* resurectTimer, Uint32* immunityTimer, Uint32* powerDurationTimer, int* nrOffSoundEffects) {
	resurectPlayer(aPlayer, resurectTimer, immunityTimer, &nrOffSoundEffects);
